...
import com.hmh.SpringBootDemoEmailApplicationTests;
...
public class MailServiceTest extends SpringBootDemoEmailApplicationTests {
    ...
    public void sendSimpleMail() {
        mailService.sendSimpleMail("hemh213@163.com", "这是一封简单邮件", "这是一封普通的SpringBoot测试邮件");
    }
    ...
    public void sendHtmlMail() throws MessagingException {
        ...
        mailService.sendHtmlMail("hemh213@163.com", "这是一封模板HTML邮件", emailTemplate);
    }
    ...
    public void sendAttachmentsMail() throws MessagingException {
        ...
        mailService.sendAttachmentsMail("hemh213@163.com", "这是一封带附件的邮件", "邮件中有附件，请注意查收！", resource.getPath());
    }
    ...
    public void sendResourceMail() throws MessagingException {
        ...
        URL resource = ResourceUtil.getResource("static/xkcoding.png");
        mailService.sendResourceMail("hemh213@163.com", "这是一封带静态资源的邮件", content, resource.getPath(), rscId);
    }
}
